...
pub struct Sosp<'a, A: Alarm , L: gpio::Pin + gpio::PinCtl > {
    alarm: &'a A,
...
impl<'a, A: Alarm, L: gpio::Pin + gpio::PinCtl > Sosp<'a, A, L> {
...
impl<'a, A: Alarm, L: gpio::Pin + gpio::PinCtl > time::Client for Sosp<'a, A, L> {
    fn fired(&self) {
...
impl<'a, A: Alarm, L: gpio::Pin + gpio::PinCtl > AmbientLightClient for Sosp<'a, A, L> {
